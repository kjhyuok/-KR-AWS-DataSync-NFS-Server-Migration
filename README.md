...
* [CleanUp](./detail/module7.md) - CleanUp: 실습에 사용했던 모든 자원을 정리<br>

***Cut-Over란***: 기존에 운영되던 정보시스템을 완전히 중단시키고, 새로 구축된 정보시스템을 본격 오픈하는 작업입니다. 본 실습 예제에서는 기존 On-premise내 NFS 서버를 AWS Storage gw로 대체하는 작업을 지칭합니다. <br>
